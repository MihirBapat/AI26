    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate z-50 max-h-64 min-w-[var(--anchor-width)] max-w-[95vw] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg bg-popover text-popover-foreground shadow-lg ring-1 ring-border p-1 duration-100",
            className
          )}
          {...props}
        >
